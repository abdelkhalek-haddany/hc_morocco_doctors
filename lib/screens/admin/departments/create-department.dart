...
class _CreateDepartmentScreenState extends State<CreateDepartmentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text('Create Department', style: TextStyle(color: Color(0xff191A1C)),),
        ),
  ...
  validate() async {
      if (_mediaFiles.isEmpty) {
        ...
        DepartmentModel department = DepartmentModel(id: uuid.v1(),
            title: titleController.text,
            thumbnail: image_url,
            description: contentController.text);

           await FireStoreUtils.createDepartment(department);
